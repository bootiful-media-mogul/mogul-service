...
(
    ...
    graphic bigint not null references managed_file
(
    id
),
    produced_graphic bigint null references managed_file
(
    id
),

    produced_audio bigint null references managed_file
(
    id
),
...
(
    ...
    segment_audio_managed_file_id bigint not null references managed_file
(
    id
),
    produced_segment_audio_managed_file_id bigint not null references managed_file
(
    id
),
