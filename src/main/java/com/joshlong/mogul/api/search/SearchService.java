...
class SearchService {
	...
	private final RowMapper<Document> hybridHitRowMapper = new HybridHitRowMapper();

	SearchService(EmbeddingModel embeddingModel, JdbcTemplate jdbc) {
		this.embeddingModel = embeddingModel;
		this.jdbc = jdbc;
	}

	public record Document(long id, String text, double score) {
