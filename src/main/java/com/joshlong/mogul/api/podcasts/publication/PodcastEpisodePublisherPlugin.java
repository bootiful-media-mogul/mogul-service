...
public interface PodcastEpisodePublisherPlugin extends PublisherPlugin<Episode> {
	 ...
	 * {@code false}, {@link ProducedAudioPublicationGate} lets the publication straight
	 * through, so publishing doesn't wait on (a potentially long) {@code ffmpeg} render
	 * in the {@code processors} module.
	 */
